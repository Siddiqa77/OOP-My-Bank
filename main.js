...
// create customers 
const customers = [
    new Customer("Hamza", "Khan", "Male", 35, 3166783676, accounts[0]),
    new Customer("Siddiqa", "Badar", "Female", 40, 3336783676, accounts[1]),
    new Customer("Ayesha", "Murtuza", "Female", 30, 3416783676, accounts[2])
];
